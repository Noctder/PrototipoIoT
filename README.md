...
| Relé + bomba 5V   | Riego automático        | GPIO 26 (IN del módulo)  |

El riego se activa si la humedad de suelo baja de un umbral, corre unos **5 s** y se apaga antes del Deep Sleep. Umbrales en `esp32/config_supabase.py`.
...
2. Completa:
   ...
   - Riego: `RIEGO_ACTIVAR_POR_DEBAJO_DE`, `RIEGO_NO_REGAR_POR_ENCIMA_DE`, `TIEMPO_RIEGO_MS`, `PIN_RELE`.
